...
@pytest.mark.parametrize(
    ("func", "kwargs", "match"),
    [
        (lambda x: x, {"name": "foo"}, "Function 'foo'.*is already registered"),
        (lambda x: x, {"name": "foo", "version": 1}, "Function 'foo'.*is already registered"),
        (lambda x: x, {"name": "foo", "version": 0}, "Function version must be greater than zero"),
        (lambda x: x, {"name": "bar", "version": 2}, "Function 'bar'.*is already registered"),
        (lambda x: x, {"name": "bar", "version": 0}, "Function version must be greater than zero"),
        (lambda x: x, {"name": "baz", "version": 3}, "Function 'baz'.*is already registered"),
        (lambda x: x, {"name": "baz", "version": 0}, "Function version must be greater than zero"),
        (lambda x: x, {}, "Function name is required"),
        (lambda x: x, {"version": 1}, "Function name is required"),
        (foo, {"name": "bar"}, "Function 'bar'.*is already registered"),
        (bar, {"name": "baz"}, "Function 'baz'.*is already registered"),
        (baz, {"name": "foo"}, "Function 'foo'.*is already registered"),
...
@pytest.mark.parametrize(
    ("func", "kwargs", "match"),
    [
        (foo, {"version": 2}, r"Function 'foo' \(version 2\) is not registered"),
        (bar, {"version": 3}, r"Function 'bar' \(version 3\) is not registered"),
        (baz, {"version": 1}, r"Function 'baz' \(version 1\) is not registered"),
        (qux, {}, "Function 'qux' is not registered"),
        (lambda: None, {}, "Function '<lambda>' is not registered"),
        ("foo", {"version": 2}, r"Function 'foo' \(version 2\) is not registered"),
        ("bar", {"version": 3}, r"Function 'bar' \(version 3\) is not registered"),
        ("baz", {"version": 1}, r"Function 'baz' \(version 1\) is not registered"),
        ("qux", {}, "Function 'qux' is not registered"),
        (Qux(), {}, "Function 'unknown' is not registered"),
        (Qux().foo, {}, "Function 'foo' is not registered"),
        (Qux().bar, {}, "Function 'bar' is not registered"),
        (Qux().baz, {}, "Function 'baz' is not registered"),
    ],
)
